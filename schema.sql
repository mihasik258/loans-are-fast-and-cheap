...
CREATE TABLE План_выплат (
    ...
    Сумма_погашения_основы DECIMAL(15, 2) NOT NULL CHECK (Сумма_погашения_основы >= 0),
    Сумма_погашения_процентов DECIMAL(15, 2) NOT NULL CHECK (Сумма_погашения_процентов >= 0),
    Сумма_погашения_штрафа DECIMAL(15, 2) NOT NULL DEFAULT 0 CHECK (Сумма_погашения_штрафа >= 0),
...
CREATE TABLE Договор_о_сотрудничестве (
    ...
    Дата_подписания DATE NOT NULL,
    Сумма_основного_долга DECIMAL(15, 2) NOT NULL CHECK (Сумма_основного_долга > 0),
    Сумма_накопленных_процентов DECIMAL(15, 2) NOT NULL DEFAULT 0 CHECK (Сумма_накопленных_процентов >= 0),
