...
def generate():
    ...
    for i in range(N_EMPLOYEE):
        ...
        br = (i % N_BRANCH) + 1
        mgr = 1 if pos != 1 else None # just simple reference
    ...
    for cl_idx in range(N_CLIENT):
        ...
        for _ in range(num_profiles):
            ...
            # emps contains tuples; element index 10 is pos, 11 is br
    ...
    for i in range(N_LOAN):
        ...
        for p in range(np):
            ...
            if st == "Оплачено":
                ...
                # Contextual description of payment
                if np > 1:
            ...
            # ID_Типа_начисления: 1 = Регулярный
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("✅ Full data loaded (test_data.sql) - completely standalone.")
        
        print("\n🎉 Database is ready and fully populated with robust financial data! ✨")
    except subprocess.CalledProcessError as e:
        print(f"\n❌ Error running SQL scripts: {e}")
